...
<template>
  <div :class="['text-input-2', 'text-input-2--' + props.name]">
    <span class="label">
...
```
  ...
  <template>
    <TextInput2 v-model="needed" name="needed" type="" placeholder="" required="" readonly="" minlength="" maxlength="" min="" max="" autocomplete="">
...
- * NOTE:
  ...
  ```
    <TextInput2 v-model="example" name="example" type="text" required>
  ```

  -- or this way if it has logic or has reactive boolean variable:
  ```
    <TextInput2 v-model="example" name="example" type="text" :required="requirement === true">
  ```
...
- SLOT:
  ...
  ```
  <TextInput2 v-model="sample" name="sample">
...
- STYLING and Additional Logic:
  ...
  -- to access an element inside:
    ...
    ---* NOTE: You can access these in the main css file depending on its stages of specificity:
      ...
      ``` css
      .text-input-2 label{}
      .text-input-2 error-message{}
      .text-input-2 input{}
      ```
      --- to style only for a specific component (no parenthesis '()'):
      ``` css
      .text-input-2--(name attribute) label{}
      .text-input-2--(name attribute) error-message{}
      .text-input-2--(name attribute) input{}
      ```
