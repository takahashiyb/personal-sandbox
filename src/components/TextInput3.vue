...
<template>
  <div :class="['text-input-3', 'text-input-3--' + props.name]">
    <span class="label">
...
```
  import TextInput3 from './components/TextInput3.vue';

  <template>
    <TextInput3 v-model="needed" name="needed" type="" placeholder="" required="" readonly="" minlength="" maxlength="" min="" max="" autocomplete="">
...
- * NOTE:
  ...
  ```
    <TextInput3 v-model="example" name="example" type="text" required>
  ```

  -- or this way if it has logic or has reactive boolean variable:
  ```
    <TextInput3 v-model="example" name="example" type="text" :required="requirement === true">
  ```
...
- SLOT:
  ...
  ```
  <TextInput3 v-model="sample" name="sample">
...
- STYLING and Additional Logic:
  ...
  -- to access an element inside:
    ...
    ---* NOTE: You can access these in the main css file depending on its stages of specificity:
      ...
      ``` css
      .text-input-3 label{}
      .text-input-3 error-message{}
      .text-input-3 input{}
      ```
      --- to style only for a specific component (no parenthesis '()'):
      ``` css
      .text-input-3--(name attribute) label{}
      .text-input-3--(name attribute) error-message{}
      .text-input-3--(name attribute) input{}
      ```
